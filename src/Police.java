...
public class Police {
    ...
    public Police() {
        ...
        setUpSuspiciousGood();
        this.description = String.format("You Encounter a police. He suspect that you "
                        + "stole %d of %s from NPCs. "
                        + "You can take 3 actions\n\n"
                        + "1. Forfeit the items. You will turn in those spoils to "
                        + "the office and leave right away.\n\n"
                        + "2. Flee Back. Try this way if you have a good "
                        + "pilot skill to escape. If you fail, "
                        + "the officer will give you a hard time confiscating those "
                        + "spoils, ruining your ship and giving you a ticket.\n\n"
                        + "3. Fight Off the police. You better have a good fighting "
                        + "skill to beat the well-trained police, or "
    ...
    private void setUpSuspiciousGood() {
        ...
        numberOfSuspiciousGood = suspiciousGood.getQuantity()
                == 1 ? 1 : random.nextInt(suspiciousGood.getQuantity());
    }
    ...
    public String dealWithFleeingPlayer() {
        ...
        if (player.getPilotSkill() > mask) {
            ...
            ship.subtractSpecificGood(new Good[]{suspiciousGood},
                    new int[]{numberOfSuspiciousGood});
